...
from mindspeed_llm.tasks.inference.legacy_mg_adapter import adapt_legacy_deepseek2_lite_checkpoint_if_needed
try:
...
def _load_base_checkpoint_wrapper(fn):
    ...
    def wrapper(*args, **kwargs):
        ...
        if state_dict is not None and isinstance(state_dict, dict):
            state_dict = adapt_legacy_deepseek2_lite_checkpoint_if_needed(state_dict, args_)
